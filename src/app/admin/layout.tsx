...
import { LayoutDashboard, Users, Upload, BarChart3, LogOut, Menu, List, Activity, Calendar } from 'lucide-react'
...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
 ...
 <Link href="/admin/lead-pool" onClick={() => setOpen(false)} className="flex items-center px-6 py-3 text-muted-foreground hover:bg-muted hover:text-foreground">
 <Users className="w-5 h-5 mr-3" />
 Lead Pool
 </Link>
 <Link href="/admin/attendance" onClick={() => setOpen(false)} className="flex items-center px-6 py-3 text-muted-foreground hover:bg-muted hover:text-foreground">
